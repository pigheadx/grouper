...
#define PI 3.14159
//#endif
#define MOTOR_BOARD_CW  -0.8
#define MOTOR_BOARD_CCW 0.5
#define MOTOR_OVER_EXCEED 0.05
#define MOTOR_TOLERANT 10
#define MOTOR_POINTS 4096
#define SCAN_LINES 300
...
class GrouperLidar
{
 ...
 private:
  ...
  int motor_goal_position_;
  int motor_present_position_;

  int scan_goal_position_[SCAN_LINES];
  int scan_position_matrix_[SCAN_LINES];
...
//  int present_scan_line_;
 ...
 private:
  ...
  bool motorReachGoal();
  int GetClosestLine(int motor_pos);
